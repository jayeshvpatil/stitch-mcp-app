...
export default function DesignContext({ data }: DesignContextProps) {
  ...
  const hasAnyTokens = colors.length > 0 || fonts.length > 0 || spacing.length > 0 || layouts.length > 0;
  ...
  return (
    <div className="view-container">
      <div className="view-header">
        <h2>Design Context</h2>
        <button className="btn btn-secondary btn-sm" onClick={handleExportCSS}>
      ...
      <div className="design-context-grid">
        ...
        {colors.length > 0 && (
          <div className="context-section">
            <h3>Colors <span className="badge">{colors.length}</span></h3>
        ...
        {fonts.length > 0 && (
          <div className="context-section">
            <h3>Typography <span className="badge">{fonts.length}</span></h3>
        ...
        {spacing.length > 0 && (
          <div className="context-section">
            <h3>Spacing <span className="badge">{spacing.length}</span></h3>
        ...
        {layouts.length > 0 && (
          <div className="context-section">
            <h3>Layout Patterns <span className="badge">{layouts.length}</span></h3>
